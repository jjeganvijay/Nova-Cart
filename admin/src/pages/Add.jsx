...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full max-w-4xl mx-auto items-start gap-6 bg-white/80 backdrop-blur-lg p-6 rounded-3xl shadow-2xl'>
        ...
        <button type="submit" className='w-32 py-3 mt-6 bg-gradient-to-r from-purple-500 to-pink-500 hover:scale-105 hover:from-purple-600 hover:to-pink-600 text-white rounded-xl shadow-lg transition-all duration-300'>ADD</button>
